<script>
  ...
  import { isPlaying, currentTrack, audioProgress, audioDuration, isLooping, isRandom, playTrack, playPause, nextTrack, prevTrack, toggleLoop, toggleRandom, formatTime, songArr, initializeAudioElements } from '$lib/store/music.js';
